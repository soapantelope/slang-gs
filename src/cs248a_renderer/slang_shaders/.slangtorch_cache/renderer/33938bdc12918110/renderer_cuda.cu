...
#line 90
__device__ AnyValue8 packAnyValue8_0(longlong _S2)
{
...
#line 90
    ulonglong _S4 = (slang_bit_cast<ulonglong>(_S2));

#line 90
    uint _S5 = uint(_S4 >> int(32));

#line 90
    (&_S3)->field0_1 = uint(_S4);
...
#line 90
__device__ longlong unpackAnyValue8_0(AnyValue8 * _S6)
{

#line 90
    return (slang_bit_cast<longlong>(((ulonglong(_S6->field1_0) << 32) + _S6->field0_1)));
}


#line 90
__device__ AnyValue4 packAnyValue4_0(float _S7)
{
...
#line 90
    (&_S8)->field0_0 = (slang_bit_cast<uint>(_S7));
...
#line 90
__device__ AnyValue8 packAnyValue8_1(ulonglong _S9)
{
...
#line 90
    uint _S11 = uint(_S9 >> int(32));

#line 90
    (&_S10)->field0_1 = uint(_S9);
...
#line 90
__device__ ulonglong unpackAnyValue8_1(AnyValue8 * _S12)
{

#line 90
    return ((ulonglong(_S12->field1_0) << 32) + _S12->field0_1);
}
...
#line 47 "/viscam/u/sophiazh/slang-gs/src/cs248a_renderer/slang_shaders/renderer.slang"
__device__ Matrix<float, 4, 4>  loadFloat4x4FromTensor_0(TensorView t_0)
{

#line 48
    float _S27 = ((t_0).load<float>((0U), (0U)));

#line 48
    float _S28 = ((t_0).load<float>((0U), (1U)));

#line 48
    float _S29 = ((t_0).load<float>((0U), (2U)));

#line 48
    float _S30 = ((t_0).load<float>((0U), (3U)));

#line 48
    float _S31 = ((t_0).load<float>((1U), (0U)));

#line 48
    float _S32 = ((t_0).load<float>((1U), (1U)));

#line 48
    float _S33 = ((t_0).load<float>((1U), (2U)));

#line 48
    float _S34 = ((t_0).load<float>((1U), (3U)));

#line 48
    float _S35 = ((t_0).load<float>((2U), (0U)));

#line 48
    float _S36 = ((t_0).load<float>((2U), (1U)));

#line 48
    float _S37 = ((t_0).load<float>((2U), (2U)));

#line 48
    float _S38 = ((t_0).load<float>((2U), (3U)));

#line 48
    float _S39 = ((t_0).load<float>((3U), (0U)));

#line 48
    float _S40 = ((t_0).load<float>((3U), (1U)));

#line 48
    float _S41 = ((t_0).load<float>((3U), (2U)));

#line 48
    float _S42 = ((t_0).load<float>((3U), (3U)));

#line 48
    return makeMatrix<float, 4, 4> (_S27, _S28, _S29, _S30, _S31, _S32, _S33, _S34, _S35, _S36, _S37, _S38, _S39, _S40, _S41, _S42);
}


#line 4 "/viscam/u/sophiazh/slang-gs/src/cs248a_renderer/slang_shaders/./model/camera.slang"
struct Camera_0
{
...
#line 56 "/viscam/u/sophiazh/slang-gs/src/cs248a_renderer/slang_shaders/renderer.slang"
__device__ Camera_0 loadCameraFromTensors_0(TensorView viewMatrix_t_0, TensorView projMatrix_t_0, uint canvas_width_0, uint canvas_height_0, float focalLength_1)
{

#line 62
    Camera_0 cam_0;
    Matrix<float, 4, 4>  _S43 = loadFloat4x4FromTensor_0(viewMatrix_t_0);

#line 63
    (&cam_0)->viewMatrix_0 = _S43;
    (&cam_0)->invViewMatrix_0 = makeMatrix<float, 4, 4> (0.0f);
    Matrix<float, 4, 4>  _S44 = loadFloat4x4FromTensor_0(projMatrix_t_0);

#line 65
    (&cam_0)->projMatrix_0 = _S44;
...
#line 13118
            ...
            float sum_1 = sum_0 + _slang_vector_get_element(left_0.rows[i_0], j_0) * _slang_vector_get_element(right_0, j_0);
...
#line 13118
        ...
        *_slang_vector_get_element_ptr(&result_0, i_0) = sum_0;
...
#line 13118
            ...
            float sum_3 = sum_2 + _slang_vector_get_element(left_1.rows[i_1], j_1) * _slang_vector_get_element(right_1, j_1);
...
#line 13118
        ...
        *_slang_vector_get_element_ptr(&result_1, i_1) = sum_2;
...
#line 13200
                ...
                float sum_5 = sum_4 + _slang_vector_get_element(left_2.rows[r_0], i_2) * _slang_vector_get_element(right_2.rows[i_2], c_0);
...
#line 13200
                ...
                float sum_7 = sum_6 + _slang_vector_get_element(left_3.rows[r_1], i_3) * _slang_vector_get_element(right_3.rows[i_3], c_1);
...
#line 53
    ...
    return make_float3 (float2 {_S48.x, _S48.y}.x, float2 {_S48.x, _S48.y}.y, _S47.z);
}
...
#line 6806
        *_slang_vector_get_element_ptr(&result_4, i_4) = (F32_min((_slang_vector_get_element(x_0, i_4)), (_slang_vector_get_element(y_0, i_4))));
...
#line 6806
        *_slang_vector_get_element_ptr(&result_5, i_5) = (F32_max((_slang_vector_get_element(x_1, i_5)), (_slang_vector_get_element(y_1, i_5))));
...
#line 9538
        float result_7 = result_6 + _slang_vector_get_element(x_4, i_6) * _slang_vector_get_element(y_2, i_6);
...
#line 9538
        float result_9 = result_8 + _slang_vector_get_element(x_5, i_7) * _slang_vector_get_element(y_3, i_7);
...
#line 7 "/viscam/u/sophiazh/slang-gs/src/cs248a_renderer/slang_shaders/./math/linalg.slang"
...
#line 36 "/viscam/u/sophiazh/slang-gs/src/cs248a_renderer/slang_shaders/./model/camera.slang"
__device__ float2  Camera_getFOV_0(Camera_0 * this_4)
{

    return make_float2 (2.0f * (F32_atan((0.5f * float(this_4->canvasSize_0.x) / this_4->focalLength_0))), 2.0f * (F32_atan((0.5f * float(this_4->canvasSize_0.y) / this_4->focalLength_0))));
}
...
#line 112
    ...
    return _S67 / makeMatrix<float, 2, 2> (_S68);
}


#line 42 "/viscam/u/sophiazh/slang-gs/src/cs248a_renderer/slang_shaders/./model/camera.slang"
__device__ float2  Camera_ndcToPixel_0(Camera_0 * this_10, float3  ndc_0)
{

#line 42
    uint2  _S69 = this_10->canvasSize_0;
    float2  _S70 = make_float2 ((float)_S69.x, (float)_S69.y);

#line 43
    return (float2 {ndc_0.x, ndc_0.y} + make_float2 (1.0f)) * _S70 * make_float2 (0.5f);
}

__device__ int2  Camera_getTileDims_0(Camera_0 * this_11)
{

#line 46
    int2  _S71 = this_11->num_tiles_0;
    uint2  _S72 = make_uint2 ((uint)_S71.x, (uint)_S71.y);

#line 47
    uint2  _S73 = this_11->canvasSize_0 / _S72;

#line 47
    int2  _S74 = make_int2 ((int)_S73.x, (int)_S73.y);
...
#line 105 "/viscam/u/sophiazh/slang-gs/src/cs248a_renderer/slang_shaders/renderer.slang"
__global__ void __kernel__preprocessGaussians(TensorView positions_1, TensorView rotations_1, TensorView scales_1, TensorView colors_1, TensorView gaussian_opacities_1, TensorView viewMatrix_t_1, TensorView projMatrix_t_1, uint canvas_width_1, uint canvas_height_1, float focalLength_2, TensorView tiles_touched_0, TensorView tile_ranges_touched_0, TensorView radii_0, TensorView opacities_0, TensorView centers_0, TensorView inv_cov2Ds_0, TensorView rgbs_0)
{

#line 125
    uint tid_0 = ((blockIdx)).x * ((blockDim)).x + ((threadIdx)).x;
    uint _S92 = ((positions_1).sizes[(0U)]);
...
#line 127
    ...
    Gaussian_0 gaussian_0 = loadGaussianFromTensors_0(tid_0, positions_1, rotations_1, scales_1, colors_1, gaussian_opacities_1);
    Camera_0 cam_6 = loadCameraFromTensors_0(viewMatrix_t_1, projMatrix_t_1, canvas_width_1, canvas_height_1, focalLength_2);
...
#line 136
    Gaussian_0 _S93 = gaussian_0;

#line 136
    Camera_0 _S94 = cam_6;

#line 136
    float3  _S95 = Gaussian_projectPoint_0(&_S93, &_S94);
...
#line 140
    Gaussian_0 _S97 = gaussian_0;

#line 140
    Camera_0 _S98 = cam_6;

#line 140
    float3  _S99 = Gaussian_computeSHColor_0(&_S97, &_S98);

#line 140
    Gaussian_0 _S100 = gaussian_0;

#line 140
    Matrix<float, 3, 3>  _S101 = Gaussian_getCov3D_0(&_S100);

#line 140
    Gaussian_0 _S102 = gaussian_0;

#line 140
    Camera_0 _S103 = cam_6;

#line 140
    Matrix<float, 2, 2>  _S104 = Gaussian_cov3Dto2D_0(&_S102, _S101, &_S103);

#line 140
    Gaussian_0 _S105 = gaussian_0;

#line 140
    float _S106 = Gaussian_getDet2D_0(&_S105, _S104);
...
#line 148
    Gaussian_0 _S107 = gaussian_0;

#line 148
    float _S108 = Gaussian_getPixelRadius_0(&_S107, _S104);

#line 148
    Gaussian_0 _S109 = gaussian_0;

#line 148
    Matrix<float, 2, 2>  _S110 = Gaussian_invertCov2D_0(&_S109, _S104);

#line 148
    Camera_0 _S111 = cam_6;

#line 148
    float2  _S112 = Camera_ndcToPixel_0(&_S111, _S95);

#line 148
    Gaussian_0 _S113 = gaussian_0;

#line 148
    Camera_0 _S114 = cam_6;

#line 148
    RectBounds_0 _S115 = Gaussian_getRectTileBounds_0(&_S113, &_S114, _S112, _S108);

#line 161
    (tiles_touched_0).store<int>((tid_0), ((_S115.maxX_0 - _S115.minX_0) * (_S115.maxY_0 - _S115.minY_0)));
    (tile_ranges_touched_0).store<int>((tid_0), (0U), (_S115.minX_0));
    (tile_ranges_touched_0).store<int>((tid_0), (1U), (_S115.maxX_0));
    (tile_ranges_touched_0).store<int>((tid_0), (2U), (_S115.minY_0));
    (tile_ranges_touched_0).store<int>((tid_0), (3U), (_S115.maxY_0));
    (radii_0).store<int>((tid_0), (int(uint(_S108))));
    (opacities_0).store<float>((tid_0), (gaussian_0.opacity_0));
    (centers_0).store<float>((tid_0), (0U), (_S112.x));
    (centers_0).store<float>((tid_0), (1U), (_S112.y));
    (centers_0).store<float>((tid_0), (2U), (_S96));
    (inv_cov2Ds_0).store<float>((tid_0), (0U), (0U), (_S110.rows[int(0)].x));
    (inv_cov2Ds_0).store<float>((tid_0), (0U), (1U), (_S110.rows[int(0)].y));
    (inv_cov2Ds_0).store<float>((tid_0), (1U), (0U), (_S110.rows[int(1)].x));
    (inv_cov2Ds_0).store<float>((tid_0), (1U), (1U), (_S110.rows[int(1)].y));
    (rgbs_0).store<float>((tid_0), (0U), (_S99.x));
    (rgbs_0).store<float>((tid_0), (1U), (_S99.y));
    (rgbs_0).store<float>((tid_0), (2U), (_S99.z));
    return;
}
...
#line 45 "/viscam/u/sophiazh/slang-gs/src/cs248a_renderer/slang_shaders/renderer.slang"
...
#line 20
    ...
    (&projected_gaussian_0)->opacity_1 = opacity_2;
    (&projected_gaussian_0)->inv_cov2D_0 = inv_cov2D_1;
